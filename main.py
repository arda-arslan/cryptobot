"""
crypto_bot is a multithreaded application that uses WebSockets and FIX protocol
to trade crypto on gdax (now Coinbase Pro).

This version was written to explore the world of high-frequency trading with
...
labeled with a TODO.
Shortcuts were purposefully taken so that development would be quicker and
more bugs could be squashed.

Development for crypto_bot stopped in approximately May 2018, and as such,
